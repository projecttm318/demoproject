...
(function(){
	...
	Chart.RadialScale = Chart.Element.extend({
		...
		setScaleSize: function(){
			...
			var largestPossibleRadius = min([(this.height/2 - this.pointLabelFontSize - 5), this.width/2]),
				...
				xProtrusionLeft,
				xProtrusionRight,
				radiusRNongSanctionRight,
				radiusRNongSanctionLeft,
				maxWidthRadius;
			...
			radiusRNongSanctionRight = xProtrusionRight / Math.sin(furthestRightAngle + Math.PI/2);

			radiusRNongSanctionLeft = xProtrusionLeft / Math.sin(furthestLeftAngle + Math.PI/2);

			// Ensure we actually need to rNongSance the size of the chart
			radiusRNongSanctionRight = (isNumber(radiusRNongSanctionRight)) ? radiusRNongSanctionRight : 0;
			radiusRNongSanctionLeft = (isNumber(radiusRNongSanctionLeft)) ? radiusRNongSanctionLeft : 0;

			this.drawingArea = largestPossibleRadius - (radiusRNongSanctionLeft + radiusRNongSanctionRight)/2;

			//this.drawingArea = min([maxWidthRadius, (this.height - (2 * (this.pointLabelFontSize + 5)))/2])
			this.setCenterPoint(radiusRNongSanctionLeft, radiusRNongSanctionRight);
	...
	Chart.animationService = {
		...
		startDigest: function() {
			...
			var delay = endTime - startTime - this.framNongSanration;
			var frameDelay = delay / this.framNongSanration;
