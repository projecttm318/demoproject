...
namespace NongSan.Common
{
    public static class StringUtils
    {
        ...
        #endregion String content helpers
        ...
        #endregion Html Element Helpers
        ...
        /// <param name="replaceWith"></param>
        /// <returns></returns>
        public static string CreateUrl(this string strInput, string replaceWith)
        {
            ...
            strInput = RemoveSignVietnamese(strInput);
        ...
        public static string ReturnSelectedComboBox(object input, object value)
        {
            if (input != null && value != null && input.ToString() == value.ToString())
            {
                return "selected";
            }
            else
        ...
        public static string FormatNumber(decimal? a)
        {
            if (a == null)
                return "0";
            return a.Value.ToString("#,##0");
        }
    }
}